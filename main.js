...
global.reloadHandler = async function(restatConn) {
  ...
  conn.sSubject = '🐲𝑳𝑼𝑪𝑲𝒀 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑬𝑳 𝑵𝑶𝑴𝑩𝑹𝑬 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑺𝑬 𝑨 𝑴𝑶𝑫𝑰𝑭𝑰𝑪𝑨𝑫𝑶';
  conn.sIcon = '🐲𝑳𝑼𝑪𝑲𝒀 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑺𝑬 𝑨 𝑪𝑨𝑴𝑩𝑰𝑨𝑫𝑶 𝑳𝑨 𝑭𝑶𝑻𝑶 𝑫𝑬 𝑷𝑬𝑹𝑭𝑰𝑳';
  conn.sRevoke = '🐲𝑳𝑼𝑪𝑲𝒀 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑬𝑳 𝑬𝑵𝑳𝑨𝑪𝑬 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑺𝑬 𝑹𝑬𝑺𝑻𝑨𝑩𝑳𝑬𝑪𝑰𝑶';
...
setInterval(async () => {
  ...
  const bio = `፧፧ 𝑳𝒖𝒄𝒌𝒚𝑩𝒐𝒕-𝑴𝑫🐲 ፧፧ 𝒎𝒂𝒙𝒊𝒎𝒂 𝒑𝒐𝒕𝒆𝒏𝒄𝒊𝒂🐉 ፧፧ 𝒑𝒓𝒐𝒑𝒊𝒆𝒕𝒂𝒓𝒊𝒐 𝑰𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎: @𝒔𝒓_.𝒈𝒓𝒔`;
