...
global.reloadHandler = async function(restatConn) {
  ...
  conn.bye = '┏━═━═━═━═━═━═━═━═━═━═┓\n┣═ @user\n┣═ -𝟷  𝑹𝒂𝒕𝒂 𝒆𝒔𝒕𝒐𝒓𝒃𝒐𝒔𝒂 🐁\n┣═ 𝑶𝒋𝒂𝒍𝒂 𝒏𝒐 𝒗𝒖𝒆𝒍𝒗𝒂𝒔 👋\n┗━═━═━═━═━═━═━═━═━═━┛';
  conn.spromote = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬  @user 𝑺𝑬 𝑺𝑼𝑴𝑨 𝑨𝑳 𝑮𝑹𝑼𝑷𝑶 𝑫𝑬 𝑨𝑫𝑴𝑰𝑺';
  conn.sdemote = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 @user  𝑨𝑩𝑨𝑵𝑫𝑶𝑵𝑨 𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑫𝑬 𝑨𝑫𝑴𝑰𝑺';
  conn.sDesc = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑳𝑨 𝑫𝑬𝑺𝑪𝑹𝑰𝑷𝑪𝑰𝑶𝑵 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑨 𝑺𝑰𝑫𝑶 𝑴𝑶𝑫𝑰𝑭𝑰𝑪𝑨𝑫𝑨';
  conn.sSubject = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑬𝑳 𝑵𝑶𝑴𝑩𝑹𝑬 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑺𝑬 𝑨 𝑴𝑶𝑫𝑰𝑭𝑰𝑪𝑨𝑫𝑶';
  conn.sIcon = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑺𝑬 𝑨 𝑪𝑨𝑴𝑩𝑰𝑨𝑫𝑶 𝑳𝑨 𝑭𝑶𝑻𝑶 𝑫𝑬 𝑷𝑬𝑹𝑭𝑰𝑳';
  conn.sRevoke = '🍆𝑻𝑹𝑨𝑮𝑨 𝑺𝑬𝑴𝑬𝑵 𝑩𝑶𝑻 𝑨𝑵𝑼𝑵𝑪𝑰𝑨 𝑸𝑼𝑬 𝑬𝑳 𝑬𝑵𝑳𝑨𝑪𝑬 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶 𝑺𝑬 𝑹𝑬𝑺𝑻𝑨𝑩𝑳𝑬𝑪𝑰𝑶';
...
setInterval(async () => {
  ...
  const bio = `𝑩𝒐𝒕 𝒂𝒄𝒕𝒊𝒗𝒐 𝟐𝟒/𝟕 🍆 𝑰𝒏𝒔𝒕𝒂𝒈𝒓𝒂𝒎 𝒅𝒆𝒍 𝒑𝒓𝒐𝒑𝒊𝒆𝒕𝒂𝒓𝒊𝒐: @𝒃𝒙𝒍𝒍.𝟎𝟐`;
