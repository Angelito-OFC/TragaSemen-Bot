...
//jadibots
const smsx.nobbot = () => { return `*📌 Este comando solo puede ser usado en el bot principal*`}

const smsx.botqr = () => { return `*Usa este Código para convertirte en Bot*\n\n1. Haga click en los tres puntos en la esquina superior derecha.\n2. Toque Dispositivos vinculados\n3. Selecciona *Vincular con el número de teléfono*\n\n*Nota:* El código solo sirve para este número`}

const smsx.ig = () => { return `hola`}
...
export default { lenguaje, smsAvisoMG, smsAvisoEG,  smsx.nobbot, smsx.botqr, smsx.ig, smsWelcome, smsBye, smsSpromote, smsSdemote, smsSdesc, smsSsubject, smsSicon, smsSrevoke, smsJoin1, smsJoin2, smsJoin}
