...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Angelito, tu seras TragaSemen-Bot.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por angelito, tu seras TragaSemen-Bot.`;
